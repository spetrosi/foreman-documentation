...
. Click the *Installation media* tab and select the installation media that apply to this operating system. When you import an operting system from Red Hat CDN, you dont need to set installation media. It can be blank. For more information, see xref:Configuring_Provisioning_Resources-Creating_Installation_Media[].
...
-----------------
+
Alternatively you can use pwkickstart command from distribution repositories or EPEL.
